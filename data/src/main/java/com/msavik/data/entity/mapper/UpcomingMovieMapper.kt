...
class UpcomingMovieMapper: Mapper<UpcomingMovieEntity, Movie> {
    override fun mapFromEntity(type: UpcomingMovieEntity): Movie {
        return Movie(
    ...
    override fun mapToEntity(type: Movie): UpcomingMovieEntity {
