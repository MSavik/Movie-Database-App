...
class PopularMovieMapper: Mapper<PopularMovieEntity, Movie> {
    override fun mapFromEntity(type: PopularMovieEntity): Movie {
        return Movie(
    ...
    override fun mapToEntity(type: Movie): PopularMovieEntity {
